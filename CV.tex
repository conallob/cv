...
\begin{itemize}[noitemsep]
	\item Overhauled SRE ad-hoc onboarding process, replacing ad-hoc tribal knowledge with documents, recorded talks \& a forum of newhires helping newhires, resulting in a measurable reduction in onboarding time for every new SRE hire
 	\item Designed \& Implemented a multi environmet (VM, CrusoeCloud, bare-metal, Kubernetes) synthetic network observability tool, built upon Cloudprober \& custom functionality
	\item Active contributed to upstream Cloudprober open source project
