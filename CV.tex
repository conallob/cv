...
\begin{itemize}[noitemsep]
	\item Overhauled SRE ad-hoc onboarding process, replacing ad-hoc tribal knowledge with documents, recorded talks \& a forum of newhires helping newhires, resulting in a measurable reduction in onboarding time for every new SRE hire
 	\item Designed \& Implemented a managed, multi environmet platform (VM, CrusoeCloud, bare-metal, Kubernetes) synthetic observability tool, built upon Cloudprober \& custom functionality
...
\section*{Professional Ceritifications}

\begin{itemize}[noitemsep]
  \item PagerDuty Incident Management
  \item Kepner-Treoge: Practitioner in Troubleshooting
\end{itemize}
