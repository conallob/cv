...
\begin{itemize}[noitemsep]
	\item Overhauled SRE ad-hoc onboarding process, replacing tribal knowledge with structured documentation, recorded talks \& a forum of new hires helping new hires, resulting in a measurable reduction in onboarding time for every new SRE hire
 	\item Designed \& Implemented a managed, multi environment platform (VM Control Plane, CrusoeCloud, Kubernetes and Fleet-wide Bare Metal) synthetic observability tool, built on Cloudprober with custom extensions
	\item Onboarded 8+ teams as users of the Managed Cloudprober platform
    \item Recognised as the observability \& PromQL expert across the company including SRE, multiple dev teams \& Customer Success
 	\item Joined Cloud Storage \& Incident Commander oncall rotations, serving as Incident Commander for 20+ incidents in 4 months
	\item Joined SDN oncall rotation, reducing oncall issues with systemic fixes, landed 5x - 10x scaling of the SDN control plane by tuning Kubernetes load balancing \& removing bottlenecks
\end{itemize}
