...
\begin{itemize}
	...
	\item Awarded a 2021 Feat of Engineering Award, for SRE Lead of a cross functional team which decommissionied a 15+ year old blackbox
		monitoring tool. Replaced packet drop alerting with new SLO targetsi \& Error Budget concepts
	\item Served as an Inclident Responder to numerous user facing outages of various severity, including some with realtime media coverage
  \end{itemize}
