...
Member of the Network Infrastructure team, responsible for running Google's network. Formed following the reorganisation of $\sim$80--90 Network Engineers into the SRE Organisation; led the embedded upskilling of $\sim$20 engineers into SRE practices by Q4 2018, featured in a \href{https://cloud.google.com/blog/products/management-tools/transitioning-a-typical-engineering-ops-team-into-an-sre-powerhouse}{Google Cloud blog post}.
...
\begin{itemize}[noitemsep]
	...
	\item Developed multiple features and member of Core Viceroy team, a Google internal equivalent of Managed Grafana.
		Viceroy is featured as a \href{https://sre.google/sre-book/communication-and-collaboration/\#case-study-of-collaboration-in-sre-viceroy-ZKsVCZ}{case study in the Google SRE Book}.
	...
	\item Formed and led a group maintaining globally distributed out-of-band disaster recovery access systems; drove hardware upgrades, rolled out IPv6 connectivity, and developed monitoring \& alerting across the fleet.
\end{itemize}
...
\section*{Education \& Earlier Career}

\begin{itemize}[noitemsep]
  \item \textbf{Degree:} BA(Mod) Hons in Computer Science --- University of Dublin, Trinity College
  \item \textbf{Employment:} Systems \& Network Administrator (concurrent) --- School of Mathematics, University of Dublin, Trinity College
\end{itemize}
